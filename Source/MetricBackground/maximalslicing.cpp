...
tensor<2, double> Black_Hole_maximal_slicing_isometric::get_metric(double M, double x, double y, double z)
{
...
tensor<3, double> Black_Hole_maximal_slicing_isometric::get_metric_deriv(double M, double x, double y,
                                               double z)
{
...
int Black_Hole_maximal_slicing_isometric::eval_diff_eqn(double t, const double y[], double f[], void *params)
{
...
Vec3 Black_Hole_maximal_slicing_isometric::set_norm(Vec3 v, double norm_val, double M)
{
